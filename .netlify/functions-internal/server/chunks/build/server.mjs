import process from 'node:process';globalThis._importMeta_=globalThis._importMeta_||{url:"file:///_entry.js",env:process.env};import { inject, ref, useSlots, toRef, computed, unref, mergeProps, withCtx, renderSlot, createBlock, createCommentVNode, openBlock, toDisplayString, Fragment, renderList, createVNode, defineComponent, shallowRef, h, resolveComponent, resolveDynamicComponent, watch, createTextVNode, provide, toValue, mergeModels, useModel, isRef, hasInjectionContext, nextTick, getCurrentInstance, onServerPrefetch, reactive, createElementBlock, cloneVNode, defineAsyncComponent, useSSRContext, Suspense, createApp, useId, withModifiers, shallowReactive, onErrorCaptured, effectScope, isReadonly, isShallow, isReactive, toRaw, useTemplateRef, toHandlers, getCurrentScope, markRaw } from 'vue';
import { s as serialize, j as defu, k as parseQuery, l as klona, m as defuFn, n as isEqual, o as hasProtocol, q as joinURL, w as withQuery, r as withTrailingSlash, t as withoutTrailingSlash, v as isScriptProtocol, x as sanitizeStatusCode, y as getContext, e as createError$1, $ as $fetch$1, z as baseURL, A as createHooks, B as executeAsync, C as toRouteMatcher, D as createRouter$1 } from '../nitro/nitro.mjs';
import { setActivePinia, createPinia, shouldHydrate } from 'pinia';
import { RouterView, createMemoryHistory, createRouter, START_LOCATION } from 'vue-router';
import colors from 'tailwindcss/colors';
import { Icon, getIcon, loadIcon as loadIcon$1, _api, addAPIProvider, setCustomIconsLoader } from '@iconify/vue';
import AOS from 'aos';
import { ssrRenderComponent, ssrRenderSlot, ssrRenderClass, ssrInterpolate, ssrRenderList, ssrRenderVNode, ssrRenderAttr, ssrRenderSuspense, ssrRenderStyle, ssrRenderAttrs } from 'vue/server-renderer';
import { useForwardPropsEmits, TooltipRoot, TooltipTrigger, TooltipPortal, TooltipContent, TooltipArrow, Primitive, useForwardProps, Slot, Separator, ToastProvider, ToastPortal, ToastViewport, ConfigProvider, TooltipProvider, AccordionTrigger, AccordionItem, NavigationMenuItem, NavigationMenuTrigger, NavigationMenuLink, NavigationMenuContent, AccordionContent, AccordionRoot, NavigationMenuRoot, NavigationMenuList, NavigationMenuIndicator, NavigationMenuViewport, ToastRoot, ToastTitle, ToastDescription, ToastAction, ToastClose, VisuallyHidden, DialogRoot, DialogContent, DialogTitle, DialogDescription, DialogClose, DialogTrigger, DialogPortal, DialogOverlay, ProgressRoot, ProgressIndicator } from 'reka-ui';
import { reactivePick, createSharedComposable, reactiveOmit, pausableFilter, useMouseInElement, useDebounceFn, createReusableTemplate } from '@vueuse/core';
...
const _routes = [
  {
    name: "index",
    path: "/",
    component: () => import('./index-Bibx6FwC.mjs')
  },
  {
    name: "about-us",
    path: "/about-us",
    component: () => import('./index-BadlsIcN.mjs')
  },
  {
    name: "dashboard",
    path: "/dashboard",
    component: () => import('./index-BVL6NiTF.mjs')
  },
  {
    name: "portfolio",
    path: "/portfolio",
    component: () => import('./index-DjRmfb6o.mjs')
  },
  {
    name: "book-event",
    path: "/book-event",
    component: () => import('./index-BhWGbTT8.mjs')
  }
];
...
const data_os_animations_3P1Nf6FlpZuPIhUwXdjzW1k_GMOmpO1KJr7A6KI2GW4 = /* @__PURE__ */ defineNuxtPlugin((nuxtApp) => {
...
const plugins = [
  ...
  data_os_animations_3P1Nf6FlpZuPIhUwXdjzW1k_GMOmpO1KJr7A6KI2GW4,
...
const _sfc_main$t = /* @__PURE__ */ Object.assign({ inheritAttrs: false }, {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ssrRenderVNode(_push, createVNode(resolveDynamicComponent(props.chip ? _sfc_main$u : unref(Primitive)), mergeProps({
        as: as.value.root
        ...
        default: withCtx(({ remaining, duration, open }, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            return [
              ...
              __props.progress && open && remaining > 0 && duration ? (openBlock(), createBlock(_sfc_main$p, mergeProps({
                key: 1,
                "model-value": remaining / duration * 100,
                color: __props.color
              }, typeof __props.progress === "object" ? __props.progress : {}, {
...
const UToaster = Object.assign(_sfc_main$n, { __name: "UToaster" });
...
const __nuxt_component_0$1 = Object.assign(_sfc_main$l, { __name: "UApp" });
const theme$c = {
          ...
          if (_push2) {
            ...
            return [
              renderSlot(_ctx.$slots, "toggle", {
                ...
                __props.toggle ? (openBlock(), createBlock(_sfc_main$q, mergeProps({
                  key: 0,
                  color: "neutral",
                  variant: "ghost",
                  "aria-label": open.value ? unref(t)("header.close") : unref(t)("header.open"),
...
const logoImage = "" + __buildAssetsURL("logo.uQ1BqmIM.png");
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ssrRenderVNode(_push, createVNode(resolveDynamicComponent(__props.as), mergeProps({
        class: ["inline-flex items-center select-none", wrapperClass.value]
      }, _attrs), {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<img${ssrRenderAttr("src", unref(logoImage))} alt="App logo" class="${ssrRenderClass([imgClass.value, "block object-contain transition-transform duration-300"])}"${_scopeId}>`);
          } else {
            return [
              createVNode("img", {
                src: unref(logoImage),
                alt: "App logo",
                class: ["block object-contain transition-transform duration-300", imgClass.value]
              }, null, 10, ["src"])
            ];
          }
        }),
...
const __nuxt_component_0 = Object.assign(_sfc_main$f, { __name: "AppLogo" });
const theme$7 = {
  "slots": {
...
const _sfc_main$8 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      const _component_UHeader = _sfc_main$g;
      const _component_NuxtLink = __nuxt_component_0$3;
        ...
        title: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_component_NuxtLink, { to: "/" }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(ssrRenderComponent(_component_AppLogo, { class: "w-auto shrink-0" }, null, _parent3, _scopeId2));
                } else {
                  return [
                    createVNode(_component_AppLogo, { class: "w-auto shrink-0" })
                  ];
                }
              }),
              _: 1
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(ssrRenderComponent(_component_NuxtLink, {
                    to: "/book-event",
                    class: {
                      "text-primary-600 font-semibold": unref(route).path.startsWith("/book"),
                      "text-gray-700 dark:text-gray-300": !unref(route).path.startsWith("/book")
                    }
                  }, {
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
...
const _sfc_main$5 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_NuxtLink = __nuxt_component_0$3;
      _push(`<footer${ssrRenderAttrs(mergeProps({ class: "bg-white/0 dark:bg-gray-950/0" }, _attrs))}><div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 space-y-12"><div class="flex flex-col md:flex-row justify-between items-center text-center md:text-left gap-6"><div class="flex items-center gap-3">`);
      _push(ssrRenderComponent(_component_AppLogo, { size: 3 }, null, _parent));
      _push(`<div><h2 class="text-xl font-bold text-gray-900 dark:text-white">${ssrInterpolate(unref(config).site.name)}</h2><p class="text-sm text-gray-600 dark:text-gray-400">${ssrInterpolate(unref(config).site.description)}</p></div></div><div class="flex items-center gap-3"><!--[-->`);
      ssrRenderList(unref(config).links.social, (item, i) => {
      ...
      _push(`<!--]--></div></div><div class="mx-auto w-full px-2 sm:px-6 lg:px-8 py-2 space-y-12"><div class="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-10 text-center sm:text-left"><!--[-->`);
      ssrRenderList(unref(config).links.navigation, (group, i) => {
        _push(`<div class="space-y-3"><h4 class="text-sm font-semibold text-gray-700 dark:text-gray-200">${ssrInterpolate(group.label)}</h4><ul class="space-y-2"><!--[-->`);
        ssrRenderList(group.links, (link) => {
          _push(`<li class="flex justify-center sm:justify-start">`);
      ...
      _push(`<!--]--></div><div class="flex flex-wrap justify-center items-center gap-5"><!--[-->`);
      ssrRenderList(unref(config).links.misc, (item, i) => {
        _push(ssrRenderComponent(_component_NuxtLink, {
          key: i,
          to: item.to,
      ...
      _push(`<!--]--></div></div><div class="border-t border-gray-200 dark:border-gray-800"></div><div class="flex flex-col md:flex-row justify-between items-center text-center md:text-left gap-6 text-sm"><p class="text-gray-500 dark:text-gray-400"> © ${ssrInterpolate(unref(year))} ${ssrInterpolate(unref(config).site.name)}. All rights reserved. </p><div class="flex flex-wrap justify-center items-center gap-6"><!--[-->`);
      ssrRenderList(unref(config).links.legal, (link, i) => {
        _push(`<a${ssrRenderAttr("href", link.to)} target="_blank" rel="noopener noreferrer" class="p-0 flex items-center gap-1 text-gray-500 dark:text-gray-400 hover:text-primary-600 dark:hover:text-primary-400 transition-colors">`);
        if (link.icon) {
        ...
        _push(`<span>${ssrInterpolate(link.label)}</span></a>`);
      });
...
const _sfc_main$4 = /* @__PURE__ */ Object.assign({ inheritAttrs: false }, {
  ...
  setup(__props) {
    ...
    const ui = computed(() => tv({ extend: tv(theme), ...appConfig2.ui?.pageCard || {} })({
      orientation: props.orientation,
      ...
      _push(ssrRenderComponent(unref(Primitive), mergeProps({
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(`</div>`);
            if (__props.to) {
              _push2(ssrRenderComponent(_sfc_main$r, mergeProps({ "aria-label": ariaLabel.value }, { to: __props.to, target: __props.target, ..._ctx.$attrs }, {
            ...
            return [
              ...
              __props.to ? (openBlock(), createBlock(_sfc_main$r, mergeProps({
                key: 1,
                "aria-label": ariaLabel.value
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_UPageCard, mergeProps({
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<a${ssrRenderAttr("href", `tel:${unref(config).site.tel}`)} target="_blank" rel="noopener noreferrer" data-v-1a1ee5ce${_scopeId}>`);
            _push2(ssrRenderComponent(_component_UIcon, {
              name: "i-lucide-phone",
              class: "w-8 h-8 text-primary-500/80 dark:text-primary-500/50"
            }, null, _parent2, _scopeId));
            _push2(`</a>`);
          } else {
            return [
              createVNode("a", {
                href: `tel:${unref(config).site.tel}`,
                target: "_blank",
...
_sfc_main$3.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/FloatingW.vue");
  return _sfc_setup$3 ? _sfc_setup$3(props, ctx) : void 0;
};
const __nuxt_component_6 = /* @__PURE__ */ Object.assign(_export_sfc(_sfc_main$3, [["__scopeId", "data-v-1a1ee5ce"]]), { __name: "FloatingW" });
const _sfc_main$2 = {
  __name: "app",
  __ssrInlineRender: true,
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_FloatingW = __nuxt_component_6;
      _push(ssrRenderComponent(_component_UApp, mergeProps({ toaster }, _attrs), {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(ssrRenderComponent(_component_FloatingW, null, null, _parent2, _scopeId));
          } else {
            return [
              ...
              createVNode(_component_FloatingW)
            ];
          }
        }),
        _: 1
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-2L40YEFk.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-B-zcEaLX.mjs'));
...
export { getDisplayValue as A, useToast as B, _sfc_main$b as C, getSlotChildrenText as D, _export_sfc as _, __nuxt_component_0$3 as a, useAppConfig as b, _sfc_main$k as c, _sfc_main$q as d, entry_default as default, _sfc_main$v as e, useLocale as f, usePortal as g, _sfc_main$t as h, isArrayOfArray as i, get as j, _sfc_main$c as k, _sfc_main$r as l, _sfc_main$s as m, _sfc_main$4 as n, omit as o, pickLinkProps as p, _sfc_main$e as q, _sfc_main$6 as r, useFormField as s, tv as t, useHead as u, useFieldGroup as v, useComponentIcons as w, looseToNumber as x, compare as y, _sfc_main$u as z };
