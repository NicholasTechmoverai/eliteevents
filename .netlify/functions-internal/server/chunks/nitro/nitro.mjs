...
const _inlineRuntimeConfig = {
  "app": {
    "baseURL": "/",
    "buildId": "65c5f37e-cb46-4d32-b791-2a54941407a3",
...
const _LXBlI9hy3tvOXFI8UHXs7VlkQla_H4sUxIJFvjoyBrI = (function(nitro) {
...
const plugins = [
  _LXBlI9hy3tvOXFI8UHXs7VlkQla_H4sUxIJFvjoyBrI
];
...
const _ra_2KE = defineCachedEventHandler(async (event) => {
...
const _lazy_rIZCTB = () => import('../routes/renderer.mjs').then(function (n) { return n.r; });

const handlers = [
  { route: '/__nuxt_error', handler: _lazy_rIZCTB, lazy: true, middleware: false, method: undefined },
  { route: '/__nuxt_island/**', handler: _SxA8c9, lazy: false, middleware: false, method: undefined },
  { route: '/api/_nuxt_icon/:collection', handler: _ra_2KE, lazy: false, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_rIZCTB, lazy: true, middleware: false, method: undefined }
];
